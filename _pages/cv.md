...
seo_title: "Academic CV | Brian W. Locke, MD, MSCI"
description: "Academic appointments, training, funding, publications, presentations, teaching, and service for Brian W. Locke, MD, MSCI."
schema_type: "WebPage"
---
...
<article class="site-container page page--cv">
  <header class="page-header">
    ...
    <p class="prose">A compact public academic CV. Browse the <a href="/publications/">complete publication list</a>; additional records are available through <a href="{{ person.profiles.google_scholar }}">Google Scholar</a> and <a href="{{ person.profiles.orcid }}">ORCID</a>.</p>
